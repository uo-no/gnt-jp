...
const STAGEB_BASELINE = {
    ...
    // 2026-07-20 J-6b: 関係詞 ὅς/ὅστις/ὅσος の gender→頭語（〜する者→〜するもの 等）で関係詞
    // チップ改善（ὅς neuter489・ὅστις5・ὅσος110）。改善 39,603 → 39,694（+91）、
    // 一致 98,138 → 98,047（−91）。chip⇔panel 不一致 0・破損形 0 維持。
    // 2026-07-20 M-7c: 純複数人称代名詞（私→私たち/あなた→あなたがた・2,087件）で number 反映。
    // 改善チップ 39,694 → 40,055（+361）、一致 98,047 → 97,686（−361）。chip⇔panel・破損形は維持。
    ...
    presented:       4258,   // Stage C P1: 括弧化された PP head（M-15 反映で +14）
};
