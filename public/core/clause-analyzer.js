...
const _WALLACE_TEXT = {
    ...
    GENITIVE_POSSESSIVE:   'ここでは、『〜の』のかたちで、それが誰のものかが示されています。',
    GENITIVE_DESCRIPTIVE:  'ここでは、『〜の』のかたちで、どのような性質のものかが描かれています。',
    GENITIVE_PARTITIVE:    'ここでは、全体の中から一部が取り出されています。',
    GENITIVE_ATTRIBUTIVE:  'ここでは、『〜の』が特徴づけのはたらきをして、様子が表されています。',
    GENITIVE_EPEXEGETICAL: 'ここでは、『〜という』のかたちで、前の語の中身が言いかえられています。',
    GENITIVE_RELATIONSHIP: 'ここでは、家族や間柄のつながりが示されています。',
    GENITIVE_MATERIAL:     'ここでは、何でできているか、その材料が示されています。',
    GENITIVE_CONTENT:      'ここでは、中に何が入っているか、その中身が示されています。',
    GENITIVE_ATTRIBUTED:   'ここでは、ことばの順序が入れかわり、性質のほうが際立たされています。',
    GENITIVE_PREDICATE:    'ここでは、『〜のものである』と言い切るかたちになっています。',
    GENITIVE_SUBJECTIVE:   'ここでは、『〜が…する』という、はたらきかける側が示されています。',
    GENITIVE_OBJECTIVE:    'ここでは、『〜を…する』という、はたらきの向かう先が示されています。',
    GENITIVE_PLENARY:      'ここでは、『〜が』とも『〜を』とも読める広がりが残されています。',
    GENITIVE_COMPARISON:   'ここでは、『〜より』と、比べる相手が示されています。',
    GENITIVE_SEPARATION:   'ここでは、『〜から離れて』と、離れる元が示されています。',
    GENITIVE_TIME:         'ここでは、いつのことか、その時が示されています。',
    GENITIVE_PLACE:        'ここでは、どこでのことか、その場所が示されています。',
    GENITIVE_AGENCY:       'ここでは、『〜によって』と、行う人が示されています。',
    GENITIVE_MEANS:        'ここでは、『〜によって』と、その手段が示されています。',
    GENITIVE_SOURCE:       'ここでは、『〜から』と、出どころが示されています。',
    GENITIVE_ABSOLUTE:     'ここでは、本筋の背景となる出来事が添えられています。',
    GENITIVE_DIRECT_OBJECT: 'ここでは、はたらきの受け手が『〜の』のかたちで示されています。',

    // Wallace 冠詞用法（§2）ごとのテンプレート
    // Phase 25B-1: 同上（文法用語なしの読書文へ改訂・従来到達不能）。
    ARTICLE_MONADIC:          'ここでは、世界にただ一つのものとして指されています。',
    ARTICLE_GENERIC:          'ここでは、特定の誰かではなく、その種類の全体のことが言われています。',
    ARTICLE_PREVIOUS_REF:     'ここでは、すでに話に出てきたものが、もう一度指されています。',
    ARTICLE_PAR_EXCELLENCE:   'ここでは、その名で真っ先に思い浮かぶ、代表的な存在が指されています。',
    ARTICLE_SIMPLE_ID:        'ここでは、どれのことかが特定されて指されています。',
    ARTICLE_WELL_KNOWN:       'ここでは、誰もが知っているあのものとして指されています。',
    ARTICLE_ABSTRACT:         'ここでは、かたちのない考えそのものが指されています。',
    ARTICLE_DEICTIC:          'ここでは、目の前のものが指し示されています。',
    ARTICLE_KATAPHORIC:       'ここでは、すぐ後で説明されるものが、先に指されています。',
    ARTICLE_GRANVILLE_SHARP:  'ここでは、並んだ二つの呼び名が、同じ一人を指しています。',
    ARTICLE_COLWELL:          'ここでは、ことばの順序によって、どちらが文の主役かが示されています。',
};
